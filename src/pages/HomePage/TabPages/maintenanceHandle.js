...
import MaintenanceOnPending from "./maintenance/maintenancePending";
import ServedMaintenance from "./maintenance/maintenanceServed";
import ExtendedMaintenance from "./maintenance/maintenanceExtended";
              ...
              <div class="grid grid-cols-1 gap-4">
                <div class="p-4 space-y-4">
                  <h2 class="text-3xl font-bold text-neutral">
                    Maintenance on Pending
                  </h2>
                  <MaintenanceOnPending />
                </div>
              </div>
            )}
            {activeTab === "Accepted" && (
