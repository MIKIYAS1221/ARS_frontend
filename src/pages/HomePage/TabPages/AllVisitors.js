...
import PendingVisitor from "./Visitors/PendingVisitor";
import AcceptedVisitor from "./Visitors/AcceptedVisitor";
import RejectedVisitor from "./Visitors/RejectedVisitor";
    ...
    <>
      ...
      <div className="flex flex-col h-full">
        <div className="px-4 pt-8">
          <h2 className="text-xl font-bold">Visitors Request </h2>
        </div>
